...
def build_parser():
    nuqe_train = nuqe.parser_for_pipeline('train')
    predictor_estimator_train = predictor_estimator.parser_for_pipeline('train')
    predictor_train = predictor.parser_for_pipeline('train')
    quetch_train = quetch.parser_for_pipeline('train')
    linear_train = linear.parser_for_pipeline('train')

    pipelineparser = PipelineParser(
        name='train',
        model_parsers=[nuqe_train, predictor_estimator_train, predictor_train, quetch_train, linear_train],
